...
>>>>>>> bd0cf4461a507796725244064bb92228afe3c0ab
----
...
=======
| [hotspot=localhost]`cluster.ip`            | IP or host name for your cluster, `localhost` by default, which is appropriate when using Docker Desktop.
| [hotspot=system-service]`system.kube.service`     | Name of the {kube} Service wrapping the `system` pods, `system-service` by default.
| [hotspot=system-node-port]`system.node.port`        | The NodePort of the {kube} Service `system-service`, 31000 by default.
| [hotspot=inventory-node-port]`inventory.node.port`        | The NodePort of the {kube} Service `inventory-service`, 32000 by default.
>>>>>>> bd0cf4461a507796725244064bb92228afe3c0ab
|===
...
[INFO] Tests run: 2, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.372 s - in it.io.openliberty.guides.system.SystemEndpointIT
[INFO]
[INFO] Results:
[INFO]
...
[INFO] Tests run: 4, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.714 s - in it.io.openliberty.guides.inventory.InventoryEndpointIT
[INFO]
[INFO] Results:
[INFO]

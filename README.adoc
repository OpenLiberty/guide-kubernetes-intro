...
Managing individual containers can be challenging. A few containers used for development by
a small team might not pose a problem, managing hundreds of containers
will give even a large team of experienced developers a headache. {kube} is

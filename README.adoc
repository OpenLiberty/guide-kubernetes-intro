...
command and have {kube} do all that updating for you. Of course this is just a simple example. The bigger value add,
...
management of pods. One example of a controller which you will use in in this guide is a deployment.

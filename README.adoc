...
Then access your microservice by `curling` or visiting http://{minikube-kp}:31249/api/name (in this case).
...
Note, that if you attempt to open a new session in a new browser tab, you will end up with the same pod.

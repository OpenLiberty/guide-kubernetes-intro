...
which tends to conflict with VirtualBox. As a result, you might find it easier to run Minikube 
with Hyper-V rather than VirtualBox if you're on Windows. For instructions on how to to do this, see 

...
[source, role="gradle_section"]
----
insert gradle instructions
----
...
[source, role="gradle_section command"]
----
gradle failsafe:integration-test
----
...
[source, role="gradle_section command"]
----
gradle failsafe:integration-test -Dsystem.service.root=$(minikube ip):31000 -Dinventory.service.root=$(minikube ip):32000
----

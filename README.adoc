...
10. Run `helm install --name ol-name --set image.pullPolicy=IfNotPresent --set image.repository=name --set image.tag=1.0-SNAPSHOT --set replicaCount=3 --set ingress.enabled=true --set ingress.secureBackends=false --set ingress.rewriteTarget=/api --set ingress.path=/name --set ssl.enabled=false --set service.port=9080 --set service.targetPort=9080 /Users/dima/Documents/repos/charts/stable/ibm-open-liberty --debug` and
run `helm install --name ol-ping --set image.pullPolicy=IfNotPresent --set image.repository=ping --set image.tag=1.0-SNAPSHOT --set replicaCount=1 --set ssl.enabled=false --set service.port=9080 --set service.targetPort=9080 /Users/dima/Documents/repos/charts/stable/ibm-open-liberty --debug`
...
```
Altenratively, use `kubectl edit ingress <ingress-name>`

...
The guide will show you the podman commands.
...
----
podman not work in Windows
----

[.tab_content]
[.linux_section]
----
Run the following podman command from a command line:
----
...
[.docker_section]
--
The guide will show you the docker commands.
...
[.linux_section]
----
Run the following docker command from a command line:
----

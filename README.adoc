...
returns the JVM systems properties of the running container and it returns the pod's name in the HTTP header
making replicas easy to distinquish from each other. The `inventory` microservice
